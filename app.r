      ...
      tabsetPanel(
        ...
        tabPanel("Model Description",
                 withMathJax(
                   ...
                   helpText("Disease dispersal rate:$$\\phi_{jk}^{h}(t)=\\overline{\\phi}_{jk}^{h}(1+σ_{jk}^{h} cos(\\frac{2\\pi t}{P}))$$"),
                   ...
                   helpText("$$\\phi_{AB}^{h}=0.4$$"),
                   helpText("Average dispersal rate at patch BA:"),
                   helpText("$$\\phi_{BA}^{h}=0.04$$"),
                   helpText("The time period can be chosen between 0 and 100 years."),
